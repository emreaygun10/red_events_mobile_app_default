...
class CustomShowManagerBottomSheet extends StatelessWidget {
  const CustomShowManagerBottomSheet({super.key});
            ...
            SizedBox(
              ...
              child: Column(
                children: [
                  ...
                  AutoSizeText(
                    LocaleKeys
                        .profile_requests_request_permission_management_info
                        .tr(),
